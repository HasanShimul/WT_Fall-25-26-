    ...
    <div class="container">
        ...
        <div class="left">
            <svg viewBox="0 0 800 600" width="400" height="300" xmlns="http://www.w3.org/2000/svg"
                ...
                <path d="M0 500 L120 500 L160 470 L200 530 L240 480 L280 500 L800 500" stroke="#9cc9ff" stroke-width="3"
            ...
            <center>
                <form action="../PHP/loginController.php" method="POST">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <p>Don't have account <a href="../PHP/regiaterController.php"> <abbr
